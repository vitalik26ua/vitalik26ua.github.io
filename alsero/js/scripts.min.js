  ...
  $("form").submit(function(e){
    ...
    $.ajax({
      ...
      success:function(data) {
        if (data != ""){
          $("input,textarea").val("");
          $('.w_m').css('display','flex');
          setTimeout(function() {
            $('.w_m').css('display','none');
             $('.window_call').css('display','none');
             $('.window_sale').css('display','none');
             $('.window_calc').css('display','none')
             $('.window_zakaz').css('display','none')
    ...
    $('.photo_full').css('display','none')
    $('.photo .h_flip').click(function(){
        $('.photo_full').css('display','block')
        var index_ph = $(this).index();
        var a = [];
        var x=0;
        $('.photo .h_flip').each( function(){
        a[x] = $(this).attr('src') ;
        x++
        });
        
        $('.photo_full').css({'background-image':'url('+a[index_ph]+')'});
        $('.photo_full').addClass('fadeIn');

    })
    $('.photo_full').click(function(){
        $('.photo_full').removeClass('fadeIn');
        $('.photo_full').css('display','none')
    })
    ...
    **************************/
    ...
    $('.calc_but').click(function(){
        $('.window_calc').css('display','block')
    })
    $('.calca').click(function(){
        $('.window_calc').css('display','none')
    })
    $('.rem_but').click(function(){
        $('.window_zakaz').css('display','block')
    })
    $('.zakaza').click(function(){
        $('.window_zakaz').css('display','none')
    })
    ...
    $('.but_menu').click(function(){
        $('.menu_hide').toggleClass('menu_show');
    })
    $('.menu_hide').click(function(){
        $('.menu_hide').removeClass('menu_show');
    })
    /**********************************
    форма связи в хеадере
    **********************************/
    var youtube_src = $('iframe').eq(0).attr('src');

    $('.but2').click(function(){
        $('.window_v').css('display','block')
		$("iframe").eq(0).attr('src', youtube_src + '?autoplay=1');
    })
    $('.vid_close').click(function(){
        $('.window_v').css('display','none');
        $('iframe').eq(0).attr('src','');
    })
    $('.but1').click(function(){
        $('.window_call').css('display','block');
    })
    $('.inp_close').click(function(){
        $('.window_call').css('display','none');
    })
    
    /*************************************
    
    форма связи в скидках
    
    ***************************************/
    $('.sale_but').click(function(){
        $('.window_sale').css('display','block')
    })
    $('.swe').click(function(){
        $('.window_sale').css('display','none');
    })
    ...
    ********************************/
    ...
    $('.s_slide').slick({
        ...
        prevArrow: '<button type="button" class="left"><img class="prev" src="images/left.png" alt=""></button>',
        nextArrow: '<button type="button" class="right"><img class="next" src="images/right.png" alt=""></button>'
    });
    /***********************
    calc
    
    **************************/
    var elem = document.querySelector('.polz');
    var init = new Powerange(elem, { min: 16, max: 256, start: 58, hideRange: true, step:1});
    var inpt = $('.slot label')
    var calc_type = 2700;
    var koof = 1;
    var koof_2 = 1;
    
    inpt.eq(0).click(function(){
        koof = 1;
    })
    inpt.eq(1).click(function(){
        koof = 0.9;
    })
    inpt.eq(2).click(function(){
        koof = 0.7;
    })
    inpt.eq(3).click(function(){
        koof_2 = 1;
        
    })
    inpt.eq(4).click(function(){
        koof_2 = 1.2;
    })
    inpt.eq(5).click(function(){
        calc_type = 2700;
    })
    inpt.eq(6).click(function(){
        calc_type = 6500;
    })
    inpt.eq(7).click(function(){
        calc_type = 8500;
    })
    inpt.click(function(){
        $('.value span').text(elem.value)
        if ((koof_2 != 0))
        {
        $('.summ p span span').eq(0).text(thousandSeparator(parseInt(elem.value*(koof*koof_2*calc_type))))
        $('.summ p span span').eq(1).text(thousandSeparator(parseInt(0.6*elem.value*(koof*koof_2*calc_type))))
        var a1 = parseInt(elem.value*(koof*koof_2*calc_type))
        var a2 = parseInt(0.6*elem.value*(koof*koof_2*calc_type))
        $('.summ p span span').eq(2).text(thousandSeparator(parseInt(a1+a2)))}
    })
    $('.polz').on('change',function(event){
       $('.value span').text(elem.value)
    ...
    ***************************************/
    $('.slot').eq(2).addClass('hidden')
    $('.slot label').eq(0).click(function(){
        $('.slot').eq(2).addClass('hidden')
        $('.summ p span span').eq(0).text('0')
        $('.summ p span span').eq(1).text('0')
        koof_2=0;
        koof_3=0
        
    })
    $('.slot label').eq(1).click(function(){
        $('.slot').eq(2).addClass('hidden')
        $('.summ p span span').eq(0).text('0')
        $('.summ p span span').eq(1).text('0')
        koof_2=0;
    ...
    $('.slot label').eq(2).click(function(){
        $('.slot').eq(2).addClass('hidden')
        $('.summ p span span').eq(0).text('0')
        $('.summ p span span').eq(1).text('0')
        koof_2=0;
    ...
    $('.slot').eq(1).click(function(){
        $('.slot').eq(2).removeClass('hidden')
    })
    ...
    *************************************/
    $('.slides img').eq(0).css('display','block');
    
    var index_slider =0;
    $('.b_l').click(function(){
        index_slider--;
        if(index_slider<0){
            index_slider=$('.slides img').length-1;}
            $('.slides img').css('display','none');
            $('.slides img').eq(index_slider).css('display','block');
        
    })
    $('.b_r').click(function(){
        index_slider++;
        if(index_slider>$('.slides img').length-1){
            index_slider=0;}
            $('.slides img').css('display','none');
            $('.slides img').eq(index_slider).css('display','block');
    ...
    $('.slides img').each(function(){
        img_w[x] = $(this).attr('src');
        x++;
    })
    x=0;
    $('.window_pic img').each(function(){
        $(this).attr('src',img_w[x]);
        x++;
    })
    $('.text .buts a').click(function(){
        $('.window_pic').css('display','flex');
    })
    $('.window_pic .but_close').click(function(){
        $('.window_pic').css('display','none');
    })
    ...
    $('.window_slide').css('display','none')
    
    $('.window_pic img').click(function(){
        ...
        xe=0;
        $('.slids img').each(function(){
            $(this).attr('src',ae[xe])
            xe++
        });
         $('.window_pic').css('display','none')
         $('.window_slide').css('display','flex')
         $('.slids img').css('display','none')
         $('.slids img').eq(index_img).css('display','block')
    })
    $('.asd').click(function(){
        $('.window_slide').css('display','none')
    })
    $('.ss_w').eq(0).click(function(){
        index_img--
        if(index_img<0){
            index_img = $('.slids img').length-1;
        }
        $('.slids img').css('display','none')
         $('.slids img').eq(index_img).css('display','block')
    })
    $('.ss_w').eq(1).click(function(){
        index_img++
        if(index_img>$('.slids img').length-1){
            index_img = 0;
        }
        $('.slids img').css('display','none')
         $('.slids img').eq(index_img).css('display','block')
    ...
    ****************************/
    $('.stoimo').eq(0).click(function(){
        $('.window_stoim').eq(0).css('display','block')
    })
    $('.stoimo').eq(1).click(function(){
        $('.window_stoim').eq(1).css('display','block')
    })
    $('.stoimo').eq(2).click(function(){
        $('.window_stoim').eq(2).css('display','block')
    })
    $('.stoimo').eq(3).click(function(){
        $('.window_stoim').eq(3).css('display','block')
    })
    
    $('.ddsw').click(function(){
        $('.window_stoim').css('display','none')
    })
...
$('.block_9').click(function() {
    $('.slider').prepend($('.slider .block_9:last'));
});*/
    $('.section_9 .before').click( function(){
    $('.section_9 .slider').prepend($('.block_9').eq(4));
    $('.block_9').removeClass('active');
    $('.block_9').removeClass('small');
    $('.block_9').eq(0).addClass('small');
    $('.block_9').eq(4).addClass('small');
    $('.block_9').eq(2).addClass('active');


 });
    $('.section_9 .after').click( function(){
    $('.section_9 .slider').append($('.block_9').eq(0));
    $('.block_9').removeClass('active');
    $('.block_9').removeClass('small');
    $('.block_9').eq(0).addClass('small');
    $('.block_9').eq(4).addClass('small');
    ...
    $('.inform').hide();
    $('.section_10 ul li').click(function(){
        indexew = $(this).index()/2;
        $('.arr').eq(indexew).toggleClass('active');
        console.log(indexew)
        if($('.inform').eq(indexew).css('display')=='none'){
            $('.inform').eq(indexew).show(100);
        }
        else{
            $('.inform').eq(indexew).hide(100);
        }
    })
    /**************************************
    
    Анимация блока скидок
    
    
    ****************************************/
        $('.box_sale').eq(0).click(function(){
            $('.percent').text('')
            $('.first_percent').text('Бесплатно')
            $('.second_percent').text('5')
            $('.who').html('Всем новоселам')
            $('.sale_zagolovok').text('АКЦИЯ ДЛЯ НОВОСЁЛОВ НОВОСТРОЕК')
            $('.sale_text').html('Вы только что получили ключи от своей новенькой квартиры в новостройке?! Эта скидка тогда для Вас!<br>Профессиональный дизайнер сделает ваше жильё уютным, а наши мастера воплотят это в жизнь. ')
            $('.sale_po').text('«дизайн проект»')
            $('.box_sale').removeClass('active')
            $('.box_sale').eq(0).addClass('active')
        })
        $('.box_sale').eq(1).click(function(){
            $('.sale_zagolovok').text('СКИДКА ДЛЯ МНОГОДЕТНЫХ СЕМЕЙ')
            $('.percent').text('%')
            $('.sale_text').html('Мы рады будем обустроить уют в Вашем жилище, что бы каждый малыш Вашей семьи чувствовал себя там комфортно')
            $('.first_percent').text('10')
            $('.second_percent').text('5')
            $('.who').text('Многодетным семьям')
            $('.sale_po').text('скидка по смете')
            $('.box_sale').removeClass('active')
            $('.box_sale').eq(1).addClass('active')
        })
        $('.box_sale').eq(2).click(function(){
            $('.percent').text('%')
            $('.sale_zagolovok').text('СКИДКА ДЛЯ ПЕНСИОНЕРОВ, ВЕТЕРАНОВ, ИНВАЛИДОВ')
            $('.first_percent').text('15')
            $('.second_percent').text('5')
            $('.sale_text').html('Скидка предоставляется при предоставлении подтверждающих документов. Скидка является многоразовой и может использоваться при повторных обращением за ремонтно-отделочными работами')
            $('.who').text('Пенсионерам,ветеранам, инвалидам')
            $('.sale_po').text('скидка по смете')
            $('.box_sale').removeClass('active')
            $('.box_sale').eq(2).addClass('active')
        })
    ...
    {
        $('.but_down').addClass('fadeOut');
        
    }
        else{
            $('.but_down').removeClass('fadeOut');
        }
     console.log($(this).scrollTop()) ;
        /********************************
        3 блок
        *****************************/
    if (($(this).scrollTop() > 1550)&($(this).scrollTop() < 2500)) 
    {
        $('.red_icons').addClass('fadeIn');
        
    }
        else{
            $('.red_icons').removeClass('fadeIn');
    }
        /********************************
        слайдер
        *****************************/
        
        if (($(this).scrollTop() > 6680)&($(this).scrollTop() < 7810)) 
    {
        $('.slider').addClass('fadeIn');
        
    }
        else{
            $('.slider').removeClass('fadeIn');
    }
        /********************************
        Партнеры
        *****************************/
        if (($(this).scrollTop() > 7844)&($(this).scrollTop() < 8750)) 
    {
        $('.partners').addClass('zoomIn');
        
    }
        else{
            $('.partners').removeClass('zoomIn');
    }
        /********************************
       
        *****************************/
        if (($(this).scrollTop() > 205)&($(this).scrollTop() < 1240)) 
    {
        $('.t_1').addClass('zoomIn');
        
    }
        else{
            $('.t_1').removeClass('zoomIn');
    }
        /********************************
        
        *****************************/
        if (($(this).scrollTop() > 650)&($(this).scrollTop() < 1594)) 
    {
        $('.str_1').addClass('bounceInLeft');
        
    }
        else{
            $('.str_1').removeClass('bounceInLeft');
    }
        /********************************
        
        *****************************/
        if (($(this).scrollTop() > 3395)&($(this).scrollTop() < 4805)) 
    {
        $('.services').eq(0).addClass('zoomIn');
        
    }
        else{
            $('.services').eq(0).removeClass('zoomIn');
    }
        /********************************
        
        *****************************/
        if (($(this).scrollTop() > 4056)&($(this).scrollTop() < 5445)) 
    {
        $('.services').eq(1).addClass('zoomIn');
        
    }
        else{
            $('.services').eq(1).removeClass('zoomIn');
    }
        /********************************
